...
# mlops-example documentation build
...
from mlops-example import __version__ as release

# -- Project information -----------------------------------------------------

project = "mlops-example"
author = "Kedro"
...
htmlhelp_basename = "mlops-exampledoc"
...
texinfo_documents = [
    (
        ...
        author,
        "mlops-example",
        "Project mlops-example codebase.",
        "Data-Science",
    )
]
